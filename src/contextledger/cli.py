...
from contextledger.github.projects import ProjectsV2Client
...
def render_history(args: argparse.Namespace) -> HistoryDocument:
    ...
    template_path = args.template or root / "templates" / "weekly.md"
...
def main() -> None:
    ...
    index_path = (output_dir / "context-index.json").resolve()
    try:
